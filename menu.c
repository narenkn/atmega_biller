 ...
 */
#define ITEM_IDX_CACHE_SIZE 256
uint8_t itemIdxs_state;
uint16_t itemIdxs_start_id;
#define ITEMIDXS_VALID (itemIdxs_state & 1)
itemIdxs_t itIdxs[ITEM_IDX_CACHE_SIZE];

...
#define MENU_MFOOTER   0x03
#define MENU_MDAYITEM  0x04
#define MENU_MDAYFULL  0x05
#define MENU_MDAYTAX   0x06
#define MENU_MMONITEM  0x07
#define MENU_MMONFULL  0x08
#define MENU_MMONTAX   0x09
#define MENU_MALLITEM  0x0A
#define MENU_MALLFULL  0x0B
#define MENU_MALLTAX   0x0C
...
#define MENU_ITEMS \
  ...
  MENU_HIER(MENU_HIER_SETTINGS) MENU_MODE(MENU_MSUPER) MENU_NAME("SD Save Item") COL_JOIN MENU_FUNC(menuSDSaveItem) COL_JOIN \
    ARG1(MENU_PR_ID, MENU_ITEM_ID) COL_JOIN ARG2(MENU_PR_ID, MENU_ITEM_NONE) ROW_JOIN \
  MENU_HIER(MENU_HIER_REPORTS) MENU_MODE(MENU_MSUPER|MENU_MDAYITEM) MENU_NAME("ItemBillRepo") COL_JOIN MENU_FUNC(menuBillReports) COL_JOIN \
    ARG1(MENU_PR_FROM_DATE, MENU_ITEM_DATE) COL_JOIN ARG2(MENU_PR_ID, MENU_ITEM_NONE) ROW_JOIN \
  MENU_HIER(MENU_HIER_REPORTS) MENU_MODE(MENU_MSUPER|MENU_MDAYFULL) MENU_NAME("FullBillRepo") COL_JOIN MENU_FUNC(menuBillReports) COL_JOIN \
    ARG1(MENU_PR_FROM_DATE, MENU_ITEM_DATE) COL_JOIN ARG2(MENU_PR_ID, MENU_ITEM_NONE) ROW_JOIN \
  MENU_HIER(MENU_HIER_REPORTS) MENU_MODE(MENU_MSUPER|MENU_MDAYTAX|MENU_MMONTAX) MENU_NAME("Tax Report  ") COL_JOIN MENU_FUNC(menuBillReports) COL_JOIN \
    ARG1(MENU_PR_FROM_DATE, MENU_ITEM_DATE) COL_JOIN ARG2(MENU_PR_ID, MENU_ITEM_NONE) ROW_JOIN \

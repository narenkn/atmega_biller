...
#define EEPROM_SETTING0_ON(X)  setting0 |= EEPROM_SETTING_ ## X
#define EEPROM_SETTING0_OFF(X) setting0 &= ~EEPROM_SETTING_ ## X
#define EEPROM_SETTING0(X)  (setting0 & EEPROM_SETTING_ ## X)
